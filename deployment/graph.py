...
MODEL_SYSTEM_MESSAGE = """{task_master_role} 
...
def task_master(state: MessagesState, config: RunnableConfig, store: BaseStore):
    ...
    task_master_role = configurable.task_master_role
   ...
   # Retrieve profile memory from the store
    ...
    system_msg = MODEL_SYSTEM_MESSAGE.format(task_master_role=task_master_role, user_profile=user_profile, todo=todo, instructions=instructions)
